...
1. Is there a measurable association between daily listening hours and depression scores?
2. Are specific genres associated with elevated anxiety or insomnia?
3. Does BPM correlate with insomnia?
4. Which variable best predicts whether music improves or worsens mood?
...
Upload mxmh_survey_results.csv using the Files sidebar
Select Runtime > Run All

All 12 visualizations will render inline. Statistical results print below each cell.
Requirements
